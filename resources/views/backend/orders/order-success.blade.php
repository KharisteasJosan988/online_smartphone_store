...
<body>
        ...
        <div id="top-header">
            <div class="container">
                <ul class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +titikkoma</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> semicolon@gmail.com</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i> Jl jalan</a></li>
                </ul>
                                ...
                                <div class="cart-dropdown">
                                    ...
                                    <div class="cart-summary">
                                        <small>{{ session('cart') ? count(session('cart')) : 0 }} Item(s)
                                            selected</small>
                                        <h5>SUBTOTAL: Rp{{ number_format($totalPrice, 2, ',', '.') }}</h5>
                                    </div>
                                    <div class="cart-btns">
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li><a href="{{ route('customer.products.index') }}">Smartphones</a></li>
                </ul>
                <!-- /NAV -->
            </div>
            <!-- /responsive-nav -->
    ...
    <div class="section">
        ...
        <div class="order-success">
            ...
            <p>Total Jumlah: Rp{{ number_format($order->total_jumlah, 2, ',', '.') }}</p>
            <p>Metode Pembayaran: {{ ucfirst($order->metode_pembayaran) }}</p>

            @if ($order->metode_pembayaran == 'qris')
                <p>Silakan scan QR code berikut untuk melakukan pembayaran melalui QRIS.</p>
                <!-- Contoh QRIS -->
                <img src="{{ asset('path-to-qris-image.png') }}" alt="QRIS Payment">
