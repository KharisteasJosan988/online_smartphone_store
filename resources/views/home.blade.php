...
@section('content')
    <!-- HEADER (from homePageUser.blade.php) -->
    <header>
        <!-- TOP HEADER -->
        <div id="top-header">
            <div class="container">
                ...
                <ul class="header-links pull-right">
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle header-profile" href="#" role="button"
                    ...
                    <div class="col-md-3 d-flex align-items-center">
                        <div class="header-logo">
                            <a href="{{ route('home') }}" class="logo">
                                <img src="{{ asset('assets/img/SEMICOLON__2_-removebg-preview.png') }}" class="img-fluid"
                                    width="30%" height="30%" alt="Logo Semicolon">
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="loginPopupLabel">Welcome Back!</h5>
                </div>
                <div class="modal-body">
                    <p>{{ __('You are logged in!') }}</p>
                    <p>Welcome to <strong>Semicolon Online Smartphone Store</strong></p>
                </div>
                ...
                <div class="col-md-6">
                    <div class="shop d-flex align-items-center justify-content-center">
                        ...
                        <div class="shop-body">
                            ...
                            <a href="{{ route('products.customer') }}" class="cta-btn">Shop now <i
    ...
    <!-- Script to show the modal popup after login -->
    <script>
        @if (session('status'))
            // Show modal popup after page load
